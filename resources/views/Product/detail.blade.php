            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 mt-3">
                        ...
                        <h5 class="pb-2 border-bottom">Giá: <span class="text-danger fw-bold">{{ number_format($current_details->price, 0, ',', '.') }}
                                VNĐ</span></h5>
                        <div class="d-grid gap-2 pb-2">
                            <script src="{{ asset('/js/cartHandler.js') }}"></script>
                            <button class="btn btn-warning" onclick="AddToCart('{{ $current_details->phone_details_id }}')">THÊM VÀO GIỎ</button>
