            ...
            <div class="container-fluid">
                <div class="row">
                        ...
                        <div class="container p-1 border-top border-end">
                            ...
                            <div class="pb-2 text-center">
                                @foreach ($other_details_colors as $row)
                                    <a class="btn btn-sm btn-outline-secondary" href="{{URL::to('/phone/' . $phone_id . '/detail/' . $row->phone_details_id . '/specs/0')}}">{{$row->color_name}}</a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4 mt-3">
                        ...
                        <h5 class="pb-2 border-bottom">Giá: <span class="text-danger fw-bold">{{ number_format($current_details->price, 0, ',', '.') }} VNĐ</span></h5>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-7 border rounded mt-2">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row p-0">
                                            <div class="col-12">
                                                <p>mình mua điện thoại này 4 lần rùi, xài rất tốt, 3 tháng hư 1 lần. recommend nha :D</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-7 border rounded mt-2">
                                    <div class="container-fluid">
                                        <div class="row pt-1 border-bottom">
                                            <div class="col-6">
                                                <h6>superman can tho <span class="lead fs-6">- 15/01/2024 16:01</span></h6>
