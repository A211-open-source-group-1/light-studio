            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarToggler1">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="#"><i class="fa fa-info-circle" aria-hidden="true"></i> Về
                                chúng tôi</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="#"><i class="fa fa-tablet" aria-hidden="true"></i> Máy tính
                                bảng</a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-item border-bottom">
                                    <a class="link-dark" href="{{ URL::to('/product/brand/0') }}">Tất cả</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"><i class="fa fa-bell-o" aria-hidden="true"></i> Khuyến
                                mãi</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    @if (Auth::check())
                                        ...
                                        <li class="dropdown-item border-bottom">
                                            <a class="link-dark text-nowrap" href="{{ route('logout') }}">Đăng
                                                xuất</a>
                                        </li>
                                    @else
                                        <li class="dropdown-item border-bottom">
                                            <a id="login-btn" class="link-dark text-nowrap" href="#">Đăng
                                                nhập</a>
                                        </li>
                                        <li class="dropdown-item border-bottom">
                                            <a id="register-btn" class="link-dark text-nowrap" href="#">Đăng
                                                ký</a>
                                        </li>
                                    @endif
                                </ul>
                    ...
                    <form class="d-flex m-1" action="{{ route('search') }}" method="POST">
                        @csrf
                        <input class="form-control me-2" name="search_string" type="search" placeholder="Tìm kiếm"
                            aria-label="Search">
