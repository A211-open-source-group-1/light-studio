                                    ...
                                    <div class="row border-top">
                                        ...
                                        @foreach ($prodsInCart as $row)
                                            ...
                                            <div class="col-3 border-bottom d-flex align-items-center">
                                                ...
                                                <input type="number" class="form-control align-middle" min="0" value="{{$currentQuantity}}">
                                                <button class="btn btn-outline-light align-middle border-0"><span class="text-dark">+</span></button>
                                                <button class="btn btn-outline-light align-middle border-0"><span class="text-dark"><i class="fa-solid fa-trash"></i></span></button>
                                            </div>
                                            <div class="col-2 border-bottom d-flex align-items-center">
                                                <?php
                                ...
                                <div class="container-fluid text-light">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="r1" type="radio" name="paymentMethod" class="form-check-input me-2" value="visa">
                                            <label for="r1"><span><i class="fa-brands fa-cc-visa"></i> </span>VISA</label>
                                            <br>
                                            <input id="r2" type="radio" name="paymentMethod" class="form-check-input me-2" value="cod">
                                            <label for="r2"><span><i class="fa-solid fa-truck"></i> </span>COD</label>
                                            <br>
                                            <input id="r4" type="radio" name="paymentMethod" class="form-check-input me-2" value="paypal">
                                            <label for="r4"><span><i class="fa-brands fa-cc-paypal"></i> </span>PayPal</label>
                                            <br>
                                            <input id="r3" type="radio" name="paymentMethod" class="form-check-input me-2" value="vnpay">
                                            <label for="r3"><span><i class="fa-solid fa-qrcode"></i> </span>VNPAY QR</label>
                                        </div>
